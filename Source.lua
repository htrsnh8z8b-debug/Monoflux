...
-- Убираем protectgui, чтобы избежать ошибок
...
-- ==================== МОБИЛЬНЫЙ ИНТЕРФЕЙС (опционально) ====================
if InputService.TouchEnabled then
